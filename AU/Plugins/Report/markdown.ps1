...
# If Package_Source_Root is specified, links will be drived from it instead of $Github_UserRepo
$Package_Source_Root_Url = if ($Params.Package_Source_Root_Url) { $Params.Package_Source_Root_Url } elseif ($Params.Github_UserRepo) { "https://github.com/$Github_UserRepo" } else { 'https://github.com/majkinetor/au-packages-template' }
$Package_Source_Branch = if ($Params.Package_Source_Branch) { $Params.Package_Source_Branch } else { 'master' }
...
$update_all_url  = "$Package_Source_Root_Url/blob/$Package_Source_Branch/update_all.ps1"
...
**UTC**: $now [![](http://transparent-favicon.info/favicon.ico)](#) [$Github_UserRepo]($Package_Source_Root_Url)
