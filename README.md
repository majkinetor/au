...
As an example, the following function uses [Invoke-WebRequest](https://technet.microsoft.com/en-us/library/hh849901.aspx?f=255&MSPPError=-2147217396) to download a page, take the first parsed link `href` attribute as a new package URL and parses version from the link itself:
